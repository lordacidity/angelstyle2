...
// same file every time. The file is never saved anywhere: it is handed back to
// the Vids builder, which keeps it for the one video it is making
// (lib/vidsLocal) and lets it go afterwards.
//
