...
// BoomInsert in lib/vidsPlan). It comes from one of two places.

/** The house BOOM: shipped with the app rather than filed, the way the room
 *  tone and the music are (lib/vidsAudio). It is one fixed thing the house
 ...
 *  export writes down. (It is not filed anywhere — see lib/vidsLocal.) */
