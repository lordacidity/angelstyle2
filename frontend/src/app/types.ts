...
export type AppSection = 'deck' | 'brandkit' | 'media' | 'vids' | 'simpler' | 'vids2' | 'carousel' | 'builder' | 'trending' | 'images' | 'board' | 'schedule' | 'prompts' | 'chatgpt' | 'trade' | 'xphoto' | 'pricer' | 'photos';
