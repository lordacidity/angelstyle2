...
export type AppSection = 'deck' | 'brandkit' | 'media' | 'vids' | 'vids2' | 'carousel' | 'builder' | 'trending' | 'images' | 'board' | 'schedule' | 'prompts' | 'chatgpt' | 'trade' | 'news' | 'xphoto' | 'pricer' | 'photos' | 'aipersona' | 'audio' | 'music';
