...
// timeline to an MP4 via lib/simpler/vidsCompose (WebCodecs in the browser — no
...
//             (lib/simpler/vidsLocal), never in the library, and goes when it is
...
//
// Every export is still written down under a short code (lib/simpler/vidsRecipe → the
...
export function VidsBuilder({
  ...
  // The Bottom card's recording lives in this tab only (lib/simpler/vidsLocal), and
  ...
  // recordings of, being nobody to trade on (see lib/simpler/vidsBottom). Either way
   ...
   *  held here for this video (lib/simpler/vidsLocal) with its three beats as marks —
