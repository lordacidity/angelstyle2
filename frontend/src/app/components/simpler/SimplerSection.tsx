...
//                               tab (lib/simpler/vidsLocal) rather than filing it;
...
import { isLocalClip } from '@/lib/simpler/vidsLocal';

export function SimplerSection({ active }: { active: boolean }) {
  ...
  // — it lives in this tab (lib/simpler/vidsLocal) — and passes through as it is.
  ...
  return (
    <div className="simpler-root vids-scroll relative flex h-full flex-col text-white">
